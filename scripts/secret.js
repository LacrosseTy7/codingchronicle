...
const games = [{
    ...
    name: 'PolyTrack',
    image: 'games/images/polytrack',
    class: 'poly-track',
    shortcutHTML: '<a href="games/polytrack.html"><img class="poly-shortcut-icon game-shortcut-icon" src="games/images/polytrack"></a>',
    href: 'games/polytrack.html',
    price: 2.46
}]
